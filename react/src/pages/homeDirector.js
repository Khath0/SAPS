  ...
  return (
    <div>
      ...
      <button className='btn' onClick={()=>changeModal1(!stateModal2)}>Ingresa Preguntas Frecuentes</button>
        <button className="btn style='color:black" onClick={()=>changeModal2(!stateModal1)}><NavLink to='/aca' >Revisar Preguntas'</NavLink></button>
        <br/>
        <button className='btn' onClick={()=>changeModal3(!stateModal3)}><NavLink to='/alo' >Revisar solicitudes'</NavLink>
        </button>
        ...
        <div>
          <form onSubmit={store}>
            ...
            <div >
            <input type="text" id='name' required class='input'  value={Categoria1} onChange={(e)=>setCategoria1(e.target.value)}></input>
